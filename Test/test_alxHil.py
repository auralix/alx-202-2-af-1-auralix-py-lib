"""alxHil - the pytest side of a bench suite (no hardware).
...
import alxHil
from alxHil import git_head, parse_banner, pytest_collection_modifyitems, run_dir

BANNER = (b"[2000-01-01 00:00:00.028] [INF] APP START\r\n"
...
def test_ALX1544_P61_hook_mirrors_proof_token_and_req_markers():
    items = [_Item("test_ALX1544_P61_hook", reqs=[("ALX-1600-P3",), ("ALX-1601-P1", "ALX-1601-P2")]),
             _Item("test_plain_name"),
             _Item("test_ALX1234_P20_soak[CR]")]
    pytest_collection_modifyitems(items)
    assert items[0].user_properties == [("proof", "ALX-1544-P61"), ("req", "ALX-1600-P3"),
                                        ("req", "ALX-1601-P1"), ("req", "ALX-1601-P2")]
...
def test_ALX1544_P62_git_head_of_a_repo_and_outside_one(tmp_path):
    head = git_head(Path(alxHil.__file__).parent)
